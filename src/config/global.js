  ...
  menuPrincipal: {
    menu: [
      ...
      },
      {
        ...
        subMenu: [
          ...
          },
          {
            icono: 'far fa-file-alt',
            numero: '1.2',
            titulo: 'Uso y función de los comprobantes de contabilidad',
            hash: 't_1_2',
          },
        ],
      },
      {
        ...
        icono: 'far fa-file-alt',
        numero: '2',
        titulo: 'Asientos contables y de ajustes',
        desarrolloContenidos: true,
        subMenu: [
          {
            icono: 'far fa-file-alt',
          ...
          },
          {
            icono: 'far fa-file-alt',
            numero: '2.2',
            titulo: 'Procedimiento para realizar ajustes contables',
            hash: 't_2_2',
          },
          {
            icono: 'far fa-file-alt',
            numero: '2.3',
            titulo: 'Ejemplos prácticos de ajustes contables',
            hash: 't_2_3',
          },
        ],
      },
      {
        ...
        icono: 'far fa-file-alt',
        numero: '3',
        titulo: 'Transacciones Contables y Ciclos',
        desarrolloContenidos: true,
        subMenu: [
          {
            icono: 'far fa-file-alt',
            numero: '3.1',
            titulo: 'Definición y clasificación de transacciones contables',
            hash: 't_3_1',
          },
        ],
      },
      {
        ...
        icono: 'far fa-file-alt',
        numero: '4',
        titulo: 'Libros de contabilidad: Libro Diario y Libro Mayor',
        desarrolloContenidos: true,
        subMenu: [
          {
            icono: 'far fa-file-alt',
            numero: '4.1',
            titulo: 'Función y estructura del Libro Diario',
            hash: 't_4_1',
          },
          {
            icono: 'far fa-file-alt',
            numero: '4.2',
            titulo: 'Estructura, uso y registros en el Libro Mayor',
            hash: 't_4_2',
          },
          {
            icono: 'far fa-file-alt',
