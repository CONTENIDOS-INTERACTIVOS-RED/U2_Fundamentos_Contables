        ...
        .row.g-0
          ...
          .col-xl-6.info-section
            .content-wrapper.px-lg-4.pt-lg-4.px-xxl-5.py-xxl-5.text-start
              ...
              p.descripcion.mb-4 La unidad aborda los fundamentos contables, centrándose en el registro de transacciones y sus elementos esenciales para la elaboración de estados financieros. Se explican conceptos como el plan de cuentas, los comprobantes de contabilidad, los asientos contables y sus ajustes, así como el ciclo contable y su impacto en la información financiera. Además, se detallan los libros contables (diario y mayor), su estructura y uso en la gestión empresarial. A través de ejemplos prácticos y ejercicios, se busca que los estudiantes adquieran habilidades para interpretar y aplicar metodologías contables en contextos reales.
