          ...
          .col-lg-10
            .row.justify-content-center.align-items-center
              .col-lg-7(data-aos="fade-left").mb-3.mb-lg-0
                p.mb-0 La contabilidad es una herramienta fundamental para la gestión eficaz de los recursos en las organizaciones. En esta unidad se abordarán los conceptos y procesos básicos involucrados en el registro de transacciones contables, los cuales son esenciales para la preparación de la información financiera. Comprender estos aspectos no solo es clave para cualquier profesional en el área contable, sino también para la correcta toma de decisiones estratégicas y operativas en el ámbito empresarial.
